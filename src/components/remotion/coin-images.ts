// Mapping coin ID -> image path pour les videos Remotion
// Ce fichier est un module serveur (pas de "use client")
...
export const COIN_IMAGES: Record<string, string> = {
  ...
  "american-buffalo-1oz-or": "coins-v2/gold/american-buffalo-1oz-or-avers.webp",
  ...
  "philharmonique-1-2oz-or": "coins-v2/gold/philharmonique-1-2oz-or-avers.webp",
  // ─── Or 1/4oz ───
  ...
  "philharmonique-1-4oz-or": "coins-v2/gold/philharmonique-1-4oz-or-avers.webp",
  // ─── Or 1/10oz ───
  "britannia-1-10oz-or": "coins-v2/gold/britannia-1-10oz-or-avers.webp",
  "kangourou-1-10oz-or": "coins-v2/gold/kangourou-1-10oz-or-avers.webp",
  "maple-leaf-1-10oz-or": "coins-v2/gold/maple-leaf-1-10oz-or-avers.webp",
  "philharmonique-1-10oz-or":
    "coins-v2/gold/philharmonique-1-10oz-or-avers.webp",
  // ─── Or special ───
  ...
  // ─── Or Libertad fractions (image partagee) ───
  ...
  "libertad-1-10oz-argent": "coins-v2/silver/libertad-1-10oz-argent-avers.webp",
  "libertad-1-20oz-argent": "coins-v2/silver/libertad-1-20oz-argent-avers.webp",
  ...
  "20-francs-turin-argent": "coins-v2/silver/20-francs-turin-argent-avers.webp",
  "10-francs-turin-argent": "coins-v2/silver/10-francs-turin-argent-avers.webp",
};

export function hasVideo(slug: string): boolean {
  return slug in COIN_IMAGES;
}
