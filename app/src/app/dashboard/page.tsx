...
import type { HoldingWithCoin, Sale, SpotPrices } from "@/types";

// Spot prices placeholder (sera remplace par metals.dev)
const SPOT_PRICES: SpotPrices = {
  gold_eur_oz: 4395,
  silver_eur_oz: 96,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="font-[family-name:var(--font-playfair)] text-2xl font-black text-[#1a1a1a]">
          Mon Portefeuille
        </h1>
