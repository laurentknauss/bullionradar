...
% --- Commande pour diagramme technique de pièce ---
\newcommand{\coindiagram}[8]{%
  % #1 = Titre (ex: KRUGERRAND 1 OZ — OR)
  % #2 = Diamètre texte (ex: 32.77 mm)
  % #3 = Épaisseur texte (ex: 2.84 mm)
  % #4 = Poids (ex: 33.93g)
  % #5 = Pureté (ex: 916,7‰)
  % #6 = Pays (ex: Afrique du Sud)
  % #7 = Depuis (ex: Depuis: 1967)
  % #8 = Info supplémentaire (ex: Liquidité: 5/5)
  \begin{center}
  \begin{tikzpicture}
    % Fond sombre
    \fill[darkbg, rounded corners=8pt] (-4.5,-3.2) rectangle (4.5,3.8);

    % Titre
    \node[text=gold, font=\small\bfseries] at (0,3.3) {#1};

    % Diamètre
    \node[text=lightgold, font=\scriptsize] at (-1.2,2.7) {#2};
    \draw[lightgold, <->] (-2.5,2.5) -- (0.1,2.5);

    % Cercle pièce (vue de face)
    \draw[lightgold, dashed] (0,0.5) circle (2cm);
    \draw[lightgold] (-0.3,0.5) -- (0.3,0.5);
    \draw[lightgold] (0,0.2) -- (0,0.8);
    \node[text=lightgold, font=\tiny] at (-2.0,-1.8) {VUE DE FACE};

    % Vue de profil
    \draw[lightgold] (3.0,0.8) rectangle (3.6,0.2);
    \draw[lightgold, <->] (3.9,0.8) -- (3.9,0.2);
    \node[text=lightgold, font=\scriptsize, anchor=west] at (4.0,0.5) {#3};
    \node[text=lightgold, font=\tiny] at (3.3,-1.8) {VUE DE PROFIL};

    % Barre d'info en bas
    \fill[darkcard] (-4.3,-2.8) rectangle (4.3,-2.2);
    \node[text=lightgold, font=\tiny] at (0,-2.5) {Poids: #4~~|~~Pureté: #5~~|~~Pays: #6~~|~~#7~~|~~#8};
  \end{tikzpicture}
  \end{center}
}
...
Le \textit{debasement} --- la dévaluation progressive des monnaies fiduciaires --- n'est pas un phénomène nouveau. Depuis que Nixon a mis fin à la convertibilité du dollar en or en 1971, toutes les monnaies du monde sont des monnaies \textit{fiat}, sans ancrage à un actif tangible.
...
\begin{itemize}
  ...
  \item En 2000, une once d'or valait $\sim$300\,€. En 2026, elle dépasse les 2\,500\,€
\end{itemize}

Le \textit{debasement trade} consiste à se positionner sur des actifs réels (or, argent physique) pour se protéger de cette érosion monétaire structurelle. Ce n'est pas de la spéculation --- c'est de la préservation de patrimoine.

\textbf{Pourquoi c'est structurel~:} les États sont endettés à des niveaux historiques (120\% du PIB en France, 130\% aux USA). La seule façon politiquement acceptable de réduire cette dette est de la diluer par l'inflation et la création monétaire. L'or est la couverture naturelle contre cette politique.
...
Le consensus mainstream (banques, médias financiers, conseillers patrimoniaux) a \textbf{systématiquement sous-estimé l'or} depuis 20 ans. En 2000, l'once était à 300\,€ et «~personne n'en voulait~». En 2026, elle dépasse 2\,500\,€.
...
\coindiagram{KRUGERRAND 1 OZ --- OR}{32.77 mm}{2.84 mm}{33.93g}{916,7\permil{}}{Afrique du Sud}{Depuis: 1967}{Liquidité: 5/5}
...
\coindiagram{MAPLE LEAF 1 OZ --- OR --- CANADA}{30.00 mm}{2.87 mm}{31.10g}{999,9\permil{}}{Canada}{Depuis: 1979}{Liquidité: 5/5}
...
\coindiagram{AMERICAN EAGLE 1 OZ --- OR --- USA}{32.70 mm}{2.87 mm}{33.93g}{916,7\permil{}}{États-Unis}{Depuis: 1986}{Liquidité: 5/5}
...
\coindiagram{PHILHARMONIQUE 1 OZ --- OR --- AUTRICHE}{37.00 mm}{2.00 mm}{31.10g}{999,9\permil{}}{Autriche}{Depuis: 1989}{Liquidité: 5/5}
...
\coindiagram{BRITANNIA 1 OZ --- OR --- ROYAUME-UNI}{38.61 mm}{2.98 mm}{31.10g}{999,9\permil{}}{Royaume-Uni}{Depuis: 1987}{Liquidité: 5/5}
...
\coindiagram{AMERICAN BUFFALO 1 OZ --- OR --- USA}{32.70 mm}{2.95 mm}{31.10g}{999,9\permil{}}{États-Unis}{Depuis: 2006}{Liquidité: 5/5}
...
\coindiagram{KANGOUROU 1 OZ --- OR --- AUSTRALIE}{32.10 mm}{2.65 mm}{31.10g}{999,9\permil{}}{Australie}{Depuis: 1986}{Liquidité: 5/5}
...
\coindiagram{LIBERTAD 1 OZ --- OR --- MEXIQUE}{34.50 mm}{2.69 mm}{31.10g}{999\permil{}}{Mexique}{Depuis: 1981}{Liquidité: 4/5}
...
Il existe plusieurs dealers de confiance en France. \textbf{BullionRadar.fr} compare les prix des principaux acteurs pour vous aider à stacker au meilleur prix.
...
Avant chaque achat, consultez \textbf{BullionRadar.fr} pour~:
\begin{itemize}
...
\coindiagram{MAPLE LEAF 1 OZ ARGENT --- CANADA}{38.00 mm}{3.15 mm}{31.10g}{999,9\permil{}}{Canada}{Depuis: 1988}{TVA: 0\%}
...
\coindiagram{SILVER EAGLE 1 OZ --- ÉTATS-UNIS}{40.60 mm}{2.98 mm}{31.10g}{999\permil{}}{États-Unis}{Depuis: 1986}{TVA: 0\%}
...
\coindiagram{PHILHARMONIQUE 1 OZ ARGENT --- AUTRICHE}{37.00 mm}{3.20 mm}{31.10g}{999\permil{}}{Autriche}{Depuis: 2008}{TVA: 0\%}
...
\coindiagram{50 FRANCS HERCULE --- FRANCE}{41.00 mm}{3.00 mm}{30.0g}{900\permil{} (27g Ag pur)}{France}{1974--1980}{TVA: 20\%}
...
En 2026, ce ratio est proche de 80--90 --- signifiant que l'argent est historiquement \textbf{sous-évalué par rapport à l'or}. Beaucoup de stackers privilégient donc l'argent dans cette configuration, anticipant un retour vers les moyennes historiques.
...
Retrouvez le Dirty Man Safe et nos recommandations de stockage sur \textbf{BullionRadar.fr}
...
\textbf{BullionRadar.fr} --- Comparez les prix de 50+ pièces d'or et d'argent chez les dealers français en temps réel. L'outil indispensable avant chaque achat.
...
\textbf{The Silver Institute} (silverinstitute.org) --- Publie chaque année le \textit{World Silver Survey}, la référence mondiale sur l'offre et la demande d'argent.

\subsection*{Communautés francophones}

\textbf{Forum Argent Métal} (forum.argentmetal.com) --- La communauté française de référence pour les stackers d'argent. Fiches techniques, retours d'expérience, alertes prix.

\textbf{Reddit r/Silverbugs} --- Communauté anglophone très active, avec de nombreux membres francophones. Idéal pour découvrir de nouvelles pièces.
...
\midrule
Cours spot argent & Kitco.com & Temps réel \\
Ratio or/argent & Macrotrends & Quotidien \\
Stocks COMEX & CME Group & Quotidien \\
Demande ETF argent & iShares, WisdomTree & Hebdomadaire \\
World Silver Survey & Silver Institute & Annuel \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{center}
Rendez-vous sur \textbf{BullionRadar.fr}\\
...
\textbf{BullionRadar.fr} --- Le comparateur indépendant de pièces d'or et d'argent en France.
\end{center}
